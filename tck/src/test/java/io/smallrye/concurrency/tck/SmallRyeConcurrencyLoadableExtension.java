 ...
 */
public class SmallRyeConcurrencyLoadableExtension implements LoadableExtension {

    @Override
    public void register(ExtensionBuilder builder) {
        builder.service(ApplicationArchiveProcessor.class, SmallRyeConcurrencyArchiveProcessor.class);
    }
